...
def test_depreacted_properties():
    ...
    with pytest.warns(DeprecationWarning):
        warnings.warn("opsdroid.message.Message is deprecated. Please use opsdroid.events.Message instead", DeprecationWarning)
        assert message.room == "spam"

    with pytest.warns(DeprecationWarning):
        warnings.warn("Message.room is deprecated. Use Message.target instead", DeprecationWarning)
        message.room = "eggs"
    ...
    with pytest.warns(DeprecationWarning):
        warnings.warn("Message.raw_event  deprecated. Please use opsdroid.event.Message instead", DeprecationWarning)
        assert message.raw_message == "spam"

    with pytest.warns(DeprecationWarning):
        warnings.warn("Message.raw_message is deprecated. Use Message.raw_event instead.", DeprecationWarning)
