...
#     console_handler.addFilter(logging.Filter(["opsdroid.loader", "matplotlib"]))
#     # console_handler.addFilter(NoParsingFilter('loader'))
...
#         # file_handler.addFilter(NoParsingFilter('loader'))
#
