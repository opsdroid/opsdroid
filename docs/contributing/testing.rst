...
Below is an example test, using the pytest-mock, pytest-asyncio and a `fixture <https://docs.pytest.org/en/stable/fixture.html>`__.
...
opsdroid test helpers (`opsdroid.testing`)
------------------------------------------

.. automodapi:: opsdroid.testing
   :headings: -#
   :no-heading:
